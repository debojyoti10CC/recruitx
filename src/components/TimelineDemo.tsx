...
import { CheckCircle, Users, Brain, Shield, Zap, Code, Video, MessageSquare, Monitor, Database, Settings, Target } from "lucide-react";
  ...
  const data = [
      ...
      content: (
        <div>
          <p className="text-neutral-800 dark:text-neutral-200 text-xs md:text-sm font-normal mb-8">
            Launched Recruitix AI with advanced proctoring, semantic analysis, and real-time monitoring capabilities
          </p>
    ...
    },
    {
      ...
      content: (
        <div>
          <p className="text-neutral-800 dark:text-neutral-200 text-xs md:text-sm font-normal mb-8">
            Developed core AI algorithms for candidate assessment and behavioral analysis. Integrated advanced proctoring technology.
          </p>
          <p className="text-neutral-800 dark:text-neutral-200 text-xs md:text-sm font-normal mb-8">
            Built the foundation for semantic similarity scoring and real-time monitoring systems that power our platform today.
          </p>
          <div className="grid grid-cols-2 gap-4">
            <img
      ...
      content: (
        <div>
          <p className="text-neutral-800 dark:text-neutral-200 text-xs md:text-sm font-normal mb-4">
            Deployed comprehensive AI recruitment platform with cutting-edge features
          </p>
          <div className="mb-8 space-y-4">
            <div className="flex gap-3 items-center text-neutral-700 dark:text-neutral-300 text-xs md:text-sm">
              ...
              <span>Technical Assessment with 25+ coding challenges</span>
            </div>
            <div className="flex gap-3 items-center text-neutral-700 dark:text-neutral-300 text-xs md:text-sm">
              <div className="w-8 h-8 bg-gray-100 dark:bg-gray-800 rounded-lg flex items-center justify-center border border-gray-200 dark:border-gray-700">
                <Video className="w-4 h-4 text-gray-700 dark:text-gray-300" />
              </div>
              <span>Live Interview with real-time proctoring</span>
            </div>
            <div className="flex gap-3 items-center text-neutral-700 dark:text-neutral-300 text-xs md:text-sm">
              <div className="w-8 h-8 bg-gray-100 dark:bg-gray-800 rounded-lg flex items-center justify-center border border-gray-200 dark:border-gray-700">
                <MessageSquare className="w-4 h-4 text-gray-700 dark:text-gray-300" />
              </div>
              <span>HR Simulation with behavioral analysis</span>
            </div>
            <div className="flex gap-3 items-center text-neutral-700 dark:text-neutral-300 text-xs md:text-sm">
              <div className="w-8 h-8 bg-gray-100 dark:bg-gray-800 rounded-lg flex items-center justify-center border border-gray-200 dark:border-gray-700">
                <img src="/brain-logo.png" alt="Brain" className="w-4 h-4 object-contain" />
              </div>
              <span>Semantic similarity scoring for accurate evaluation</span>
            </div>
            <div className="flex gap-3 items-center text-neutral-700 dark:text-neutral-300 text-xs md:text-sm">
              <div className="w-8 h-8 bg-gray-100 dark:bg-gray-800 rounded-lg flex items-center justify-center border border-gray-200 dark:border-gray-700">
                <Shield className="w-4 h-4 text-gray-700 dark:text-gray-300" />
              </div>
              <span>Advanced security and integrity monitoring</span>
            </div>
          </div>
          <div className="grid grid-cols-2 gap-4">
            <img
